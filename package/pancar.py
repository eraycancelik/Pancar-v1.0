...
from ui.gearbox_new import GearBox_Ui_Dialog
from ui.vehicle_new import Vehicle_Ui_Dialog
from ui.env_new import Env_Ui_Dialog
...
class Ui_VehicleDynamicsApp(object):
    ...
    def about(self):
        url = "https://github.com/eraycancelik/Pancar-v1.0"
        webbrowser.open(url)
        print("triggered")
