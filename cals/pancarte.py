...
from package.utils import kmh_to_ms
import shelve
import webbrowser
from package.graphs import EngineDataGraph
from package.calculations import (
...
from package.ui.gearbox_new import GearBox_Ui_Dialog
from package.ui.vehicle_new import Vehicle_Ui_Dialog
from package.ui.env_new import Env_Ui_Dialog
...
class Ui_VehicleDynamicsApp(object):
    def setupUi(self, VehicleDynamicsApp):
        ...
        db = shelve.open("db/gearboxes.db")
        dkeys = list(db.keys())
        dkeys.sort()
        ...
        db = shelve.open("db/environments.db")
        dkeys = list(db.keys())
        dkeys.sort()
    ...
    def environment(self):
        self.Dialog = QtWidgets.QDialog()
        self.ui = Env_Ui_Dialog()
        self.ui.setupUi(self.Dialog)
        self.Dialog.show()

    def gearbox(self):
        self.Dialog = QtWidgets.QDialog()
        self.ui = GearBox_Ui_Dialog()
        self.ui.setupUi(self.Dialog)
        self.Dialog.show()
...
if __name__ == "__main__":
    ...
    engine_db = shelve.open("db/engines.db")
